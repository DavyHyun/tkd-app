  ...
  setTimeout(() => setp2FireLB(0), 2000);
    ...
    const done = () => {
      ...
      if (maxRounds + "" === round + "") {
        ...
        navigate("/round3", {state:{redName:location.state.redName, blueName:location.state.blueName, rounds:location.state.rounds, timer: location.state.timer, blueScore: blueScore, redScore: redScore}});
      }
    }
